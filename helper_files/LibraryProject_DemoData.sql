...
--DBCC CHECKIDENT ('LibraryBranches', RESEED, 0);
--GO
--DBCC CHECKIDENT ('LibraryCards', RESEED, 0);
--GO
--DBCC CHECKIDENT ('Statuses', RESEED, 0);
--GO
--DBCC CHECKIDENT ('Patrons', RESEED, 0);
--GO
--DBCC CHECKIDENT ('BranchHours', RESEED, 0);
--GO
--DBCC CHECKIDENT ('CheckoutHistories', RESEED, 0);
--GO
--DBCC CHECKIDENT ('Checkouts', RESEED, 0);
--GO
--DBCC CHECKIDENT ('LibraryAssets', RESEED, 0);
--GO

--INSERT INTO 
--LibraryBranches(ImageUrl, [Address], [Name], Telephone, OpenDate, [Description]) 
--VALUES 
--('/images/branches/1.png', '328 Maple St', 'Greenery Library', '555-1234', '1975-05-13', 'A verde-covered building, once confused as a jungle. The coffee shop is now open during library hours of operation.'),
...
--INSERT INTO 
--Patrons([Address], DateOfBirth, FirstName, LibraryBranchId, LastName, LibraryCardId, TelephoneNumber) VALUES
--('3708 Davis Ct', '1989-05-04', 'Miles', 1, 'Vendetti', 1, '555-1234'),
--('328 Maple St', '1989-04-09', 'Emily', 2, 'Krueger', 2, '555-7785'),
--('18 Stone Cir', '1956-02-10', 'Tomas', 2, 'Galloway', 3, '555-3467'),
--('328 Maple St', '1997-01-17', 'Rosie', 3, 'the Cat', 4, '555-1223'),
...
('Book', 12.50, 1, 2, 'Gabriel Garcia Marquez', '821.544', '9789631420494', 'One Hundred Years of Solitude', 1967, NULL, '/images/default.png', 1),
...
('Video', 24.00, 2, 2, NULL, NULL, NULL, 'Blue Velvet',	1986, 'David Lynch', '/images/default.png', 1),
('Video', 24.00, 2, 2, NULL, NULL, NULL, 'Trois Coleurs: Rouge', 1994, 'Krzysztof Kieslowski', '/images/default.png', 1),
('Video', 30.00, 2, 2, NULL, NULL, NULL, 'Citizen Kane',	1941, 'Orson Welles', '/images/default.png', 1),
('Video', 28.00, 3, 2, NULL, NULL, NULL, 'Spirited Away',	2002, 'Hayao Miyazaki', '/images/default.png', 1),
